...
const RecipeScreen = ({route, navigation, user}) => {
    ...
    useEffect(() => {
        ...
        axios.get(`${environment.API_URL}/recetas/puntaje/${user}/${idRecipe}`)
    ...
    const ratingCompleted = (rating) => {
        axios.post(`${environment.API_URL}/recetas/puntuar/${idRecipe}/${user}/${rating}`)
